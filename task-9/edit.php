...
$statement = $pdo->prepare("SELECT * FROM tasknine WHERE id=:id");
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <p>Обычная таблица-изменить
                        <a href="task_9.php" class="float-right btn btn-primary">Назад</a>
                    </p>
                    <div class="panel-content">
                        <div class="bg-warning-100 border border-warning rounded">
                            <form action="update.php$task['id']; ?>" method="post">

                                <div class="form-group">
                                    <input type="text" name="title" class="form-control" value="<?= $fetchs['text'];?>">
                                </div>
                                <div class="form-group">
