...
$statement = $pdo->prepare("SELECT * FROM tasksix");
$statement->execute();
                    ...
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        ...
                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                            ...
                            <div class="ml-2 mr-3">
                                ...
                                -
                                <a href="https://wrapbootstrap.com/user/<?php echo $person['bootstrap'];?>" class="text-info fs-sm"
                                   target="_blank" title="Contact <?php echo $person['name'];?>"><i class="fal fa-envelope"></i></a>
                            </div>
                        </div>
                        <?php else:?>
